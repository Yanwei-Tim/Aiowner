package com.dudu.aiowner.ui.activity.bind.decoding;/*
...
final class DecodeHandler extends Handler {
	...
	private final DeviceBindActivity activity;
	/**
	 * 解析条形码
	 */
	private final MultiFormatReader multiFormatReader;

	DecodeHandler(DeviceBindActivity activity, Hashtable<DecodeHintType, Object> hints) {
