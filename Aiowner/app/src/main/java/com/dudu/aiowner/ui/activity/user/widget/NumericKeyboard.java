package com.dudu.aiowner.ui.activity.user.widget;
...
import com.dudu.aiowner.utils.DigitalPswUtils.SystemUtils;
...
public class NumericKeyboard extends View {
    ...
    public static final int BLUE        = 0xFF00BFFF;
    /*
     * 判断刷新数据
     * -1 不进行数据刷新
     * 0  按下刷新
    ...
    private void initData(Context context) {
        ...
        // 获取绘制1的y坐标
        first_y = (SystemUtils.getSystemDisplay(context)[1] - SystemUtils.getSystemDisplay(context)[1] / 3) / 7;
        //添加每一排的横坐标
        xs[0] = first_x + 10;
        xs[1] = first_x * 2 + 10;
        xs[2] = first_x * 3 + 10;
